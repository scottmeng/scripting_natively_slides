...
var HelloWorldModel = (function (_super) {
    ...
    HelloWorldModel.prototype.fetchMyTweets = function() {
        var that = this;
        ...
        fetchTweets(this._accessToken, function(err, res) {
          ...
          for (var i in res) {
            ...
            if (tweet.retweeted_status) {
                imageUrl = tweet.retweeted_status.user.profile_image_url;
            }
    ...
    function fetchTweets(token, callback) {
      ...
      var options = {
          url: "https://api.twitter.com/1.1/statuses/user_timeline.json?count=10&screen_name=kaizhimeng",
          method: 'GET',
          headers: {
